shinydashboard::dashboardPage(skin = "blue",
  ...
  shinydashboard::dashboardBody(
    shinydashboard::box(
      title = "Message Generated", width = 4, solidHeader = TRUE, status = "primary", shiny::textOutput(outputId = "nText")
    ),
    shinydashboard::box(
      title = "SAMPLE", width = 4, solidHeader = TRUE, status = "primary", shiny::textOutput(outputId = "sample")
    ),
    shiny::tags$head(
